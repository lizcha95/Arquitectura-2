...
>>>>>>> 91a043aa8f630feff54cc710018334cf3e1216be
...
proceso:
	...
	clearLine:
		...
		clearLineLoop:
			...
			mov [line + rcx], byte 0 								;limpiar la primer linea
	...
	clearLine2:
		...
		clearLine2Loop:
			...
			mov [line2 + rcx], byte 0 									;limpiar la segunda linea
	...
	clear_in_file:
		...
		clear_in_fileL:
			...
			mov [in_file + rcx], byte 0 								;limpiar el buffer de entrada
	...
	limpiar_Buffer_:
		...
		limpiar_Buffer_Loop:
			...
			mov [auxBufferLine + rcx], byte 0 								;limpirar lo buffers auxiliares
	...
	limpiar_Buffer_2:
		...
		limpiar_Buffer_2Loop:
			...
			mov [auxBufferLine2 + rcx], byte 0 								;limpiar segundo  uffer auxiliar
	...
	limpiar_Buffer_3:
		...
		limpiar_Buffer_3Loop:
			...
			mov [auxBufferLine3 + rcx], byte 0 								;limpiar tercer buffer auxiliar
